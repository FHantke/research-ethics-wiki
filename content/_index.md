...
Research is guided by moral principles, which we call research ethics. In the context of computer security and privacy research, research ethics is driven by [four goal sets]({{< relref "docs/goals" >}}) -- impact on the outside world; impact on the S&P community; impact on individual community members; and the external perception. 
Ethical considerations in the S&P domain are particularly important due to:
...
We would recommending to start by reading about the [ethics procedure]({{< relref "docs/ethics-procedure" >}}) and [ethical considerations sections]({{< relref "docs/procedure-elements/ethics-section" >}}).
